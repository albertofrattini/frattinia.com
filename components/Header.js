            ...
            <div className="container flex flex-wrap justify-between items-center mx-auto">
                ...
                >
                    <svg
                        ...
                        className="w-6 h-6 dark:hidden text-gray-700"
                        viewBox="0 0 20 20"
                    ...
                    <svg
                        ...
                        className="w-6 h-6 hidden text-gray-200"
                        viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg"
                    >
                        <path
                ...
                >
                    ...
                    <svg
                        className="hidden w-6 h-6 text-gray-700"
                        fill="currentColor"
                        viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg"
                    >
                ...
                >
                    <ul className="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
                        <li className="block py-2 pr-4 pl-3 text-gray-700 dark:text-white">
                            <Link href="/">Home</Link>
                        </li>
                        <li className="block py-2 pr-4 pl-3 text-gray-700 dark:text-white">
